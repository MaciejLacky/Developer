    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var resultRole = await UserManager.AddToRoleAsync(uzytkownik.Id, "Klienci");
                    if (resultRole.Succeeded)
                    {
                        using (DeveloperContext db = new DeveloperContext())
                        {
                            Client client = new Client
                            {
                                FirstName = model.Imie,
                        ...
                        // For more information on how to enable account confirmation and password reset please visit http:
